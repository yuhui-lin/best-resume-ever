...
<div class="resume">
  ...
  <div class="leftCol m_box">
    ...
    <a :href="'https://www.linkedin.com/in/'+person.contact.github" target="_blank">
      <div class="item">
        <div class="icon">
  ...
  <div class="rightCol">
    ...
    <div class="block" v-for="education in person.education">
      ...
      <div class="rightheadline">{{education.timeperiod}}</div>
      <div style="clear: both;">
        <div class="subheadline">{{education.organization}}</div>
        <div class="rightsubheadline">{{education.location}}</div>
      </div>
      <ul class="infos">
        <li class="info" v-for="description in education.description">
          {{ description }}
        </li>
      </ul>
    </div>
    ...
    <div class="block" v-for="experience in person.experience">
      <div class="block-helper"></div>
      <div class="headline">{{experience.position}}</div>
      <div class="rightheadline">{{experience.timeperiod}}</div>
      <div style="clear: both;">
        <div class="subheadline">{{experience.company}}</div>
        <div class="rightsubheadline">{{experience.location}}</div>
      </div>
      <ul class="infos">
        <li class="info" v-for="description in experience.description">
          {{ description }}
        </li>
      </ul>
    </div>
